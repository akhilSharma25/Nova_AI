...
const Footer=()=> {
  ...
  <>
        ...
        <footer className="flex flex-col items-center justify-center w-full py-18 bg-gradient-to-b from-[#5524B7] to-[#380B60] text-white/70">
...
/>
            ...
            <p className="mt-1 text-center">Copyright © 2025 <a href="https://prebuiltui.com">Nova-AI</a>. All rights reservered.</p>
